...
@NamedStoredProcedureQueries({
    @NamedStoredProcedureQuery(
            name = "mv_pa_cliente_select_ofertasNuevas",
            procedureName = "mv_pa_cliente_select_ofertasNuevas",
            resultClasses = mv_pa_cliente_select_ofertasNuevasEntity.class)
})

public class mv_pa_cliente_select_ofertasNuevasEntity {
    ...
    public Integer productoRestante;
    ...
    @JsonProperty("Vr_PagarLiderFormABIERTA")
    public String Vr_PagarLiderFormABIERTA;

    @JsonProperty("Vr_PagarLiderFormCERRADA")
    public String Vr_PagarLiderFormCERRADA;
