...
@NamedStoredProcedureQueries({
    @NamedStoredProcedureQuery(
            name = "paC_OfertasHistorial",
            procedureName = "paC_OfertasHistorial",
            resultClasses = OfertasHistorialEntity.class)
})
public class OfertasHistorialEntity {
    ...
    public Integer idEstadoEntrega;

    @JsonProperty("DescEstadoEntrega")
    public String DescEstadoEntrega;

    @JsonProperty("evidenciaUrl")
